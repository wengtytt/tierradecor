            ...
            <div className="footer-inner">
                ...
                <div class="html-block">
                    <div className="social-list">
                        <a href="https://www.instagram.com/tierradecorcanada/" target="_blank">
                        ...
                        <a href="https://www.facebook.com/tierra.decor.1/" target="_blank">
                ...
                <div className="html-block">
                    <p style={{ textAlign: 'center', whiteSpace: 'pre-wrap' }}>
                        50 Colonnade Rd B200, Nepean, ON K2E 7J6 <br></br>©
